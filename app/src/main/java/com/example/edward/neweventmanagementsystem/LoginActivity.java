...
//        MediaPlayer ring= MediaPlayer.create(LoginActivity.this,R.raw.backgroundmusic);
...
//        ring.start();
        ...
        mEmailView = (EditText) findViewById(R.id.editLogin);
...
//        }
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Register =  new Intent(LoginActivity.this, com.example.edward.neweventmanagementsystem.Register.class);
...
//        signOut.setVisibility(View.VISIBLE);
        ...
        if (acct != null) {
            ...
            Toast.makeText(this, "User account:" + personName + " log in successfully! ", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Log.w(TAG, "loginWithEmailFail:failure", task.getException());
